...
At the moment, most of our data is sourced from scraping flyers (チラシ) where possible. However, a large part is also community driven where community sourced data is collected where the community so wishes to contribute.

Specs
WMT is a Ruby on Rails application.
